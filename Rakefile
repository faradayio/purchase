...
require_or_fail('jeweler', 'Jeweler (or a dependency) not available. Install it with: gem install jeweler') do
  Jeweler::Tasks.new do |gem|
    ...
    gem.add_development_dependency 'sniff', '~>0.4.12' unless ENV['LOCAL_SNIFF']
    ...
    # gem.add_dependency 'fastercsv', '~>1.5.3' unless ENV['LOCAL_EMITTER']
    # gem.add_dependency 'slither', '~>0.99.3' unless ENV['LOCAL_EMITTER']
  end
